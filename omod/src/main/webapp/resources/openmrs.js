 ...
 */
function loadOptionalRootConfig() {
    return __awaiter(this, void 0, void 0, function* () {
        let rootConfigExists;
        try {
        ...
        if (rootConfigExists) {
            try {
                const rootConfig = yield System.import("root-config");
                if (rootConfig.activatorOverrides) {
                    if (typeof rootConfig.activatorOverrides === "object" &&
                        !Array.isArray(rootConfig.activatorOverrides)) {
                        return rootConfig.activatorOverrides;
                    }
                    else {
                        throw Error("activatorOverrides must be an object with module names as keys. Got type " +
 ...
 * SPA.
 */
function setupApps(modules, activatorOverrides) {
    const promises = [];
        ...
        if (typeof setup === "function") {
            ...
            if (result && typeof result === "object") {
                ...
                promises.push(System.import(singleSpa).then(({ registerApplication }) => {
                    registerApplication(appName, result.lifecycle, preprocessActivator(activator));
                }));
            }
        }
    }
...
function initializeSpa(config) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield Object(_system__WEBPACK_IMPORTED_MODULE_0__["loadModules"])([...libs, singleSpa]);
        const [apps, activatorOverrides] = yield Promise.all([
            loadApps(),
            loadOptionalRootConfig()
        ]);
        yield setupApps(apps, activatorOverrides || {});
        runShell();
    });
}
